...
function initUpdater(api) {
  updater = (0, _lodash.debounce)(function ({
    ...
    const paths = api.paths,
          cwd = api.cwd;
    const filePath = (0, _path.relative)((0, _path.join)(cwd, (0, _utils.genRoutesPath)(api)), filename);
    const routePath = (0, _utils2.normalizePath)(filePath.replace((0, _path.extname)(filePath), ''));
    ...
    function routePatch(route) {
      ...
      if (route.path === routePath) {
        ...
        (0, _vm.runInContext)(`temp=${source}`, context);
