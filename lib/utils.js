...
exports.collectScrollBehavior = collectScrollBehavior;
...
function collectScrollBehavior(context) {
  const temp = context.temp;
  const scrollBehavior = temp.scrollBehavior; // 如果 block 里面定义了 scrollBehaviors
